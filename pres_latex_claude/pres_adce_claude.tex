...
\definecolor{trafocolor}{HTML}{7415A7}       % Violeta transformador
\definecolor{compcolor}{HTML}{023E8A}        % Azul compensador
...
\begin{frame}{Recordatorio 1: Transformador Convencional}
    \begin{columns}
        ...
        \column{0.5\textwidth}
        \centering
        % Placeholder para imagen de transformador convencional
        \fbox{\begin{minipage}[c][4cm][c]{4cm}
            \centering
            {\large\color{darkgray}\faImage}\\
            \vspace{0.3em}
            {\footnotesize\color{darkgray} Insertar imagen de\\transformador convencional}
        \end{minipage}}
